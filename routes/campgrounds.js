...
router.post('/', isLoggedIn, validateCampground, catchAsyncError(async (req, res, next) => { // Create new campground
...
router.put('/:id', isLoggedIn, validateCampground, catchAsyncError(async (req, res) => {
    const { id } = req.params
